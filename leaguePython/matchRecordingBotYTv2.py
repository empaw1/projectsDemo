...
riotApiKey = "RGAPI-a89e2f88-f15a-48f9-bfff-fec0349aa0b6"
...
def uploadVideo(playerPosition,regionLetters,highestKDA,finalInfo,enemyNumber,matchNumber,playerNumber):
  ...
  j=0
  while j == 0:
    selectFiles = pya.locateOnScreen('C:\\Users\\forry\\Pictures\\selectfiles.png', confidence=.8)
    if selectFiles:
        j = 1
        print('starting editing process')
        time.sleep(2)
  ...
  selectFiles = pya.locateOnScreen('C:\\Users\\forry\\Pictures\\selectfiles.png', confidence=.8)#going to 'add' field
  ...
  button = pya.locateOnScreen('C:\\Users\\forry\\Pictures\\uploadthumbnail.png', confidence=.8)
  pya.moveTo(button)
  time.sleep(1)
  pya.click()#
  time.sleep(2)
  ...
  pya.hotkey('ctrl', 'a')
  time.sleep(.5)
  clip.copy(r'C:\Users\forry\Documents\Wondershare\Wondershare Filmora\Snapshot')
  time.sleep(.1)
  pya.hotkey('ctrl', 'v')
  time.sleep(.5)
  pya.press('enter')
  ...
  button = pya.locateOnScreen('C:\\Users\\forry\\Pictures\\private.png', confidence=.8)
  pya.moveTo(button)
  time.sleep(1)
  pya.click()#
  time.sleep(2)

  button = pya.locateOnScreen('C:\\Users\\forry\\Pictures\\save.png', confidence=.8)
  pya.moveTo(button)
  time.sleep(1)
  pya.click()#
  time.sleep(5)
  ...
  j=0
  while j == 0:
    startImage = pya.locateOnScreen('C:\\Users\\forry\\Pictures\\uploading.png', confidence=.8,region = (1139,822,1213,861))
    if startImage:
